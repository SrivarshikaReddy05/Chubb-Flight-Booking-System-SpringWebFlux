...
public class BookingServiceImpl implements BookingService {
	...
	public BookingServiceImpl(FlightInventoryRepository flightRepo, BookingRepository bookingRepo) {
	...
	public Mono<Boolean> cancelBookingByPnr(String pnr) {
		return bookingRepo.findByPnr(pnr).flatMap(b -> bookingRepo.delete(b).thenReturn(true)).defaultIfEmpty(false);
	}
